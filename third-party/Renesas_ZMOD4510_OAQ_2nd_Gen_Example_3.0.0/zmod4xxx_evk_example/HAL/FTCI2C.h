...
enum { FT2232H_DEVICE_TYPE = 1, FT4232H_DEVICE_TYPE = 2 };
...
#define FTC_FAILED_TO_COMPLETE_COMMAND                                         \
    20 // cannot change, error code mapped from FT2232c classes
#define FTC_FAILED_TO_SYNCHRONIZE_DEVICE_MPSSE                                 \
    21 // cannot change, error code mapped from FT2232c classes
#define FTC_INVALID_DEVICE_NAME_INDEX                                          \
    22 // cannot change, error code mapped from FT2232c classes
#define FTC_NULL_DEVICE_NAME_BUFFER_POINTER                                    \
    23 // cannot change, error code mapped from FT2232c classes
#define FTC_DEVICE_NAME_BUFFER_TOO_SMALL                                       \
    24 // cannot change, error code mapped from FT2232c classes
#define FTC_INVALID_DEVICE_NAME                                                \
    25 // cannot change, error code mapped from FT2232c classes
#define FTC_INVALID_LOCATION_ID                                                \
    26 // cannot change, error code mapped from FT2232c classes
#define FTC_DEVICE_IN_USE                                                      \
    27 // cannot change, error code mapped from FT2232c classes
#define FTC_TOO_MANY_DEVICES                                                   \
    28 // cannot change, error code mapped from FT2232c classes

#define FTC_NULL_CHANNEL_BUFFER_POINTER                                        \
    29 // cannot change, error code mapped from FT2232h classes
#define FTC_CHANNEL_BUFFER_TOO_SMALL                                           \
    30 // cannot change, error code mapped from FT2232h classes
#define FTC_INVALID_CHANNEL                                                    \
    31 // cannot change, error code mapped from FT2232h classes
#define FTC_INVALID_TIMER_VALUE                                                \
    32 // cannot change, error code mapped from FT2232h classes
...
FTCI2C_API
FTC_STATUS WINAPI I2C_GetDeviceNameLocID(DWORD dwDeviceNameIndex,
                                         LPSTR lpDeviceNameBuffer,
                                         DWORD dwBufferSize,
                                         LPDWORD lpdwLocationID);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetHiSpeedDeviceNameLocIDChannel(
    DWORD dwDeviceNameIndex, LPSTR lpDeviceNameBuffer, DWORD dwBufferSize,
    LPDWORD lpdwLocationID, LPSTR lpChannel, DWORD dwChannelBufferSize,
    LPDWORD lpdwHiSpeedDeviceType);

FTCI2C_API
FTC_STATUS WINAPI I2C_Open(FTC_HANDLE *pftHandle);

FTCI2C_API
FTC_STATUS WINAPI I2C_OpenEx(LPSTR lpDeviceName, DWORD dwLocationID,
                             FTC_HANDLE *pftHandle);

FTCI2C_API
FTC_STATUS WINAPI I2C_OpenHiSpeedDevice(LPSTR lpDeviceName, DWORD dwLocationID,
                                        LPSTR lpChannel, FTC_HANDLE *pftHandle);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetHiSpeedDeviceType(FTC_HANDLE ftHandle,
                                           LPDWORD lpdwHiSpeedDeviceType);
...
FTCI2C_API
FTC_STATUS WINAPI I2C_CloseDevice(
    FTC_HANDLE ftHandle, PFTC_CLOSE_FINAL_STATE_PINS pCloseFinalStatePinsData);
...
FTCI2C_API
FTC_STATUS WINAPI
I2C_TurnOnDivideByFiveClockingHiSpeedDevice(FTC_HANDLE ftHandle);

FTCI2C_API
FTC_STATUS WINAPI
I2C_TurnOffDivideByFiveClockingHiSpeedDevice(FTC_HANDLE ftHandle);

FTCI2C_API
FTC_STATUS WINAPI
I2C_TurnOnThreePhaseDataClockingHiSpeedDevice(FTC_HANDLE ftHandle);

FTCI2C_API
FTC_STATUS WINAPI
I2C_TurnOffThreePhaseDataClockingHiSpeedDevice(FTC_HANDLE ftHandle);

FTCI2C_API
FTC_STATUS WINAPI I2C_SetDeviceLatencyTimer(FTC_HANDLE ftHandle,
                                            BYTE timerValue);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetDeviceLatencyTimer(FTC_HANDLE ftHandle,
                                            LPBYTE lpTimerValue);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetClock(DWORD dwClockDivisor,
                               LPDWORD lpdwClockFrequencyHz);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetHiSpeedDeviceClock(DWORD dwClockDivisor,
                                            LPDWORD lpdwClockFrequencyHz);

FTCI2C_API
FTC_STATUS WINAPI I2C_SetClock(FTC_HANDLE ftHandle, DWORD dwClockDivisor,
                               LPDWORD lpdwClockFrequencyHz);
...
FTCI2C_API
FTC_STATUS WINAPI I2C_SetGPIOs(FTC_HANDLE ftHandle,
...
FTCI2C_API
FTC_STATUS WINAPI
I2C_SetHiSpeedDeviceGPIOs(FTC_HANDLE ftHandle, BOOL bControlLowInputOutputPins,
...
FTCI2C_API
FTC_STATUS WINAPI I2C_GetGPIOs(FTC_HANDLE ftHandle,
...
FTCI2C_API
FTC_STATUS WINAPI I2C_GetHiSpeedDeviceGPIOs(
    FTC_HANDLE ftHandle, BOOL bControlLowInputOutputPins,
    PFTC_LOW_HIGH_PINS pLowPinsInputData, BOOL bControlHighInputOutputPins,
...
FTCI2C_API
FTC_STATUS WINAPI
I2C_Write(FTC_HANDLE ftHandle, PWriteControlByteBuffer pWriteControlBuffer,
...
FTCI2C_API
FTC_STATUS WINAPI
I2C_Read(FTC_HANDLE ftHandle, PWriteControlByteBuffer pWriteControlBuffer,
         DWORD dwNumControlBytesToWrite, BOOL bControlAcknowledge,
         DWORD dwControlAckTimeoutmSecs, DWORD dwDataReadTypes,
         PReadDataByteBuffer pReadDataBuffer, DWORD dwNumDataBytesToRead);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetDllVersion(LPSTR lpDllVersionBuffer,
                                    DWORD dwBufferSize);

FTCI2C_API
FTC_STATUS WINAPI I2C_GetErrorCodeString(LPSTR lpLanguage,
                                         FTC_STATUS StatusCode,
                                         LPSTR lpErrorMessageBuffer,
                                         DWORD dwBufferSize);
