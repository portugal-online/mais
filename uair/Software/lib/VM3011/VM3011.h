...
#define VM3011_I2C_CTRL_WDT_ENABLE_MASK (1U<<0)
...
#define VM3011_I2C_CTRL_WDT_DLY_MASK (3U<<1)
...
#define VM3011_WOS_FILTER_LPF_MASK (3U<<0)
...
#define VM3011_WOS_FILTER_HPF_MASK (3U<<2)
